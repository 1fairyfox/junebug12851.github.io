...
**Version:** `0.9.4` (single source of truth: repo-root `VERSION`; see
...
- **Hub:** [`../hub/`](../hub/) holds the cross-project standards + templates and
  ...
  **Both siblings are now fully onboarded** (mesh-aware `CLAUDE.md` + a fairyfox-themed
  ...
  git-flow + process-reports + compliance + express-authorizations on 2026-06-26).
...
- **Warm redesign is shipped (`0.4.x`; the repo is now at `0.9.4`).** The design language, the
